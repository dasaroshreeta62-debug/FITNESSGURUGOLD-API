        ...
        try {
            ...
            $this->db->prepare("
                UPDATE member_profiles SET
                    ...
                    country_id = CASE WHEN :country IS NOT NULL THEN :country WHEN country_id <= 0 THEN NULL ELSE country_id END,
                    state_id = CASE WHEN :state IS NOT NULL THEN :state WHEN state_id <= 0 THEN NULL ELSE state_id END,
                    district_id = CASE WHEN :district IS NOT NULL THEN :district WHEN district_id <= 0 THEN NULL ELSE district_id END,
                    city_id = CASE WHEN :city IS NOT NULL THEN :city WHEN city_id <= 0 THEN NULL ELSE city_id END,
